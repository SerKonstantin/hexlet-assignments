...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        ...
        List<String> error1 = List.of("length less than 3");
        List<String> error2 = List.of("can not be null");
        Map<String, List<String>> expected2 = Map.of("country", error2, "city", error1);
        assertThat(result2).isEqualTo(expected2);
    }
    // END
}
